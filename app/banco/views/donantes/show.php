          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12 animated flash">
                ...
                <?php
                $end_Date=$donante->estatus->fecha;
                $end = \Carbon\Carbon::parse($end_Date);
                $now = \Carbon\Carbon::now();
                $lengthFromEnd = $end->diffInDays($now);
                ?>
                <?php if ($lengthFromEnd <= 90): ?>
                <i class="fa fa-calendar-check-o fa-2x text-success" aria-hidden="true"></i> <b>El paciente esta dentro del tiempo aceptable.</b>
                <?php else: ?>
                <i class="fa fa-calendar-times-o fa-2x text-danger" aria-hidden="true"></i> <b>El paciente no esta dentro del tiempo aceptable.</b>
                <?php endif ?>
                <?php else: ?>
              ...
              <div class="col-lg-12">
                ...
                <a class="btn btn-default animated fadeInUp" href="<?php echo baseUrl ?>banco/serologias/<?php echo $donante->id ?>">
                  <i class="fa fa-tint fa-2x text-default text-danger" aria-hidden="true"></i>  Ver Serologia
                </a>
                <?php else: ?>
                <a class="btn btn-default animated fadeInUp" href="<?php echo baseUrl ?>banco/serologias/create/<?php echo $donante->id ?>">
                  <i class="fa fa-tint fa-2x" aria-hidden="true"></i> Ingresar Serologia
                </a>
                <?php endif ?>
              </div>
            </div>
